        ...
        <div id="domcraft" v-if="opened">
            ...
            <div class="left-wrapper">
                ...
                <div class="items-wrapper">
                    <div v-for="(item, key) in items" :key="`${item.item}_${key}`" @click="changeSelected(item, key)" class="item" :class="{'active-item': item.item === itemSelected.item}">
                        ...
                        <div class="item-infos">
                            ...
                            <div class="item-box-wrapper">
                                <div v-for="(requirement, index) in item.requires.slice(0, 4)" :key="`${requirement.item}_${index}`" class="item-box">
            ...
            <div v-if="itemSelected && itemSelected.requires" class="main-wrapper">
                ...
                <div class="product-items">
                    <div v-for="(requirement, index) in itemSelected.requires.slice(0, 6)" :key="`${requirement.item}_${index}`" class="product-item">
...
.item::before {
    ...
    width: 120%;
    height: 120%;
    background: radial-gradient(73.36% 223.6% at -3.81% 47.6%, rgba(204, 0, 0, 0.2) 0%, rgba(0, 100, 255, 0) 100%);
    opacity: 0;
...
.product-photo {
    width: 21.875vw;
    height: 19.792vw;
    background: url('domcraft/template/images/photo-frame.svg');
    background-size: 100% 100%;
    margin-top: 1.198vw;
    display: flex;
    justify-content: center;
...
.notify {
    ...
    background: radial-gradient(73.36% 223.6% at -3.81% 47.6%, rgba(204, 0, 0, 0.2) 0%, rgba(0, 100, 255, 0) 100%), #101010;
    border-radius: 0.521vw;
    display: flex;
    flex-direction: column;
    justify-content: center;
...
export default {
    ...
    computed: {
        imageSrc() {
            return (item) => {
                return `http://177.54.148.31:4020/lotus/inventario/${item}.png`
            }
        },
        formattedTime() {
