...
-- PRISÃO ADM
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent('prisaoADM',function(status)
    prisioneiro = status
    local ped = PlayerPedId()
...
function mdt.setarRoupasPrisional()
    ...
    if GetEntityModel(PlayerPedId()) == GetHashKey('mp_m_freemode_01') then
        ...
        SetPedComponentVariation(PlayerPedId(), 4, 161, 0, 2)
        ...
        SetPedComponentVariation(PlayerPedId(), 11, 445, 0, 2)
    ...
    elseif GetEntityModel(PlayerPedId()) == GetHashKey('mp_f_freemode_01') then
        ...
        SetPedComponentVariation(PlayerPedId(), 4, 169, 0, 2)
        ...
        SetPedComponentVariation(PlayerPedId(), 11, 514, 0, 2)
        SetPedPropIndex(PlayerPedId(), 0, -1, 0, 0)
