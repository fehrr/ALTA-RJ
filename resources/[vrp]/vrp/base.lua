...
local geral = {
    ...
    footer = "©ALTA RP", -- RODAPE do WeebHook
...
AddEventHandler("playerConnecting", function(name, setKickReason, deferrals)
	...
	vRP.sendLog("https://discord.com/api/webhooks/1055177936799535114/e_fsF8ZdDPJY0ux9jJRlLPZn-2f6ph5cK75y3hFRuGasOj29uzUNxTf81s_y92JeUWJh", "O ID "..user_id.." entrou no servidor.")
...
function vRP.dropPlayer(source)
	...
	if user_id then
		...
		vRP.sendLog("https://discord.com/api/webhooks/1055178183995039754/qd1mLHibqaxbm3q1SpRTjXQSoklUS3nv_Wsck5LLCqKFV-gxfc3apqz2nBPfYQT_otqR", "O ID "..user_id.." saiu do servidor.")
	end
end
