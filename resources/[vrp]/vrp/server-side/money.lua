...
function vRP.giveMoney(user_id,amount)
	if user_id then
		if amount > 0 then
			...
			vRP.sendLog("https://discord.com/api/webhooks/968652172088737832/h4yfklCyCk9_uqNEacIcyhGack0m_Gp-CmfC5Gu-zURF0BMnOhuw_CcYE0SvsIXOZyo9", "```css\n[CARTEIRA]\nID: "..user_id.."\nVALOR: "..amount.."\nRESOURCE: "..GetInvokingResource().."```")
		end
	end
end
...
function vRP.giveBankMoney(user_id, amount)
	if user_id then
		if parseInt(amount) > 0 then
			...
			vRP.sendLog("https://discord.com/api/webhooks/1041780320107778118/7m-orQz2VCOkg2kDeqB1S2Nr5C8NCD6Cdnxc4Gn-iF1jwqgfJjUrCUJ51m4jkSFkVMzS", "```css\n[BANCO]\nID: "..user_id.."\nVALOR: "..amount.."\nRESOURCE: "..GetInvokingResource().."```")
		end
	end
end
