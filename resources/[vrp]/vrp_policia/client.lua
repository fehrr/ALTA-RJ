...
function src.enviarIdentidade(status, id, nome,sobrenome,idade,registro,telefone,carteira,trabalho)
    if status then
        local html = string.format("<div id='simplehud'> <div class='label_carteira'><img src='https://media.discordapp.net/attachments/999123993330200656/1111409407218171934/logo.png?width=517&height=602' style='width: 120px;'></div> <div class='info_carteira'> <div class='info_section'> PASSAPORTE: <span class='info'>"..id.."</span> </div> </div> <div class='info_carteira'> <div class='info_section'> NOME: <span class='info'> "..nome.. " "..sobrenome.. " ("..idade..")</span> </div> </div> <div class='info_carteira'> <div class='info_section'> RG: <span class='info'> "..registro.. "</span> </div> </div> <div class='info_carteira'> <div class='info_section'> Telefone: <span class='info'> "..telefone.. "</span> </div> </div> <div class='info_carteira'> <div class='info_section'> Trabalho: <span class='info'> "..trabalho.. "</span> </div> </div> <div class='info_carteira'> <div class='info_section'> Carteira: <span class='info'> "..carteira.. "</span> </div> </div> </div>")
