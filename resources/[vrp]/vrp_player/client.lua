...
Citizen.CreateThread(function()
	while true do
        ...
        SetDiscordAppId(1081229211324387390)
        SetDiscordRichPresenceAssetText('discord.gg/m8pT38YvUX')
		SetDiscordRichPresenceAsset("logobot")
        SetRichPresence("Jogadores Conectados: "..players)
        SetDiscordRichPresenceAction(0, "JOGAR", "fivem://connect/cfx.re/join/yrrq75")
        SetDiscordRichPresenceAction(1, "DISCORD", "https://discord.gg/m8pT38YvUX")
    ...
    CreateThread(function()
        while isInTrunkIn do
            ...
            if IsControlJustReleased(0,51) then
                TriggerServerEvent('player:trunkin')
            end
            Wait(0)
        end
    end)
